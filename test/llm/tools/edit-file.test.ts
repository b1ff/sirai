...
describe('EditFileTool', () => {
    ...
    it('should handle line number trimming in start and end line content', async () => {
        // Set up a file content for this test
        fsReadFileStub.resolves('line 1\nline 2\nline 3\nline 4\nline 5');
        ...
        const result = await editFileTool.execute({
            ...
            changes: [{
                replace_start_line_number: 2,
                replace_start_line_content: '2: line 2',
                replace_end_line_number: 4,
                replace_end_line_content: '4: line 4',
                new_content: 'new line 2\nnew line 3\nnew line 4'
            }]
        });
    ...
    it('should handle different line number formats in start and end line content', async () => {
        // Set up a file content for this test
        fsReadFileStub.resolves('line 1\nline 2\nline 3\nline 4\nline 5');
